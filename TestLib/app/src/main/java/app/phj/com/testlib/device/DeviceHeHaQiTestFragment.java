...
public class DeviceHeHaQiTestFragment extends RCBaseFragment {
    ...
    private int deviceId = RCDeviceDeviceID.HEHAQI;

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.fragment_device_test_hehaq, null);
        ButterKnife.bind(this, view);
        rcBlueTooth = RCBluetoothHeHaQiImpl.getInstance(mActivity);
    ...
    //    String mac = "S000ZZ0C38";
    String mac = "S000ZZ03PT";

    @OnClick({R.id.function_list_01, R.id.function_list_02, R.id.function_list_03,
            R.id.function_list_04, R.id.function_list_06})
    ...
    private RCBluetoothGetDataListener getDataListener = new RCBluetoothGetDataListener() {
        @Override
        ...
        public void dataInfo(JSONArray array) {
            mRcHandler.sendMessage(RCHandler.GETDATA_OK);
            RCLog.e(TAG, "获取到数据->" + array.toString());
    ...
    private void sendInstruct(int doType) {
        ...
        rcBlueTooth.sendInstruct(getDataListener, mac, doType);
    }
    ...
    private Runnable runnable = new Runnable() {
        ...
        public void run() {
            info2.setText(
                    RCBluetoothHeHaQiImpl.getInstance(mActivity).isConnect() ? "已连接" : "未连接");

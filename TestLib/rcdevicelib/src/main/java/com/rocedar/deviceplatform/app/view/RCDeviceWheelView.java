 ...
 * @author JiangPing
 */
public class RCDeviceWheelView extends View {
    /**
     * 控件宽度
     */
    ...
    public RCDeviceWheelView(Context context, AttributeSet attrs,
                             int defStyle) {
    ...
    public RCDeviceWheelView(Context context) {
        super(context);
        initData();
    }
...
//            RCLog.e("滑动了占位的view报错，不用处理");
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray attribute = context.obtainStyledAttributes(attrs,
                R.styleable.RCDeviceWheelView);
        unitHeight = (int) attribute.getDimension(
                R.styleable.RCDeviceWheelView_unitHight, 32);
        normalFont = attribute.getDimension(
                R.styleable.RCDeviceWheelView_normalTextSize, 14.0f);
        selectedFont = attribute.getDimension(
                R.styleable.RCDeviceWheelView_selectedTextSize, 22.0f);
        itemNumber = attribute.getInt(R.styleable.RCDeviceWheelView_itemNumber, 7);
        normalColor = attribute.getColor(
                R.styleable.RCDeviceWheelView_normalTextColor, 0xff000000);
        selectedColor = attribute.getColor(
                R.styleable.RCDeviceWheelView_selectedTextColor, 0xffff0000);
        lineColor = attribute.getColor(R.styleable.RCDeviceWheelView_lineColor,
                0xff000000);
        lineWidth = attribute.getDimension(R.styleable.RCDeviceWheelView_lineHeight, 2f);
        maskHight = attribute.getDimension(R.styleable.RCDeviceWheelView_maskHight,
                48.0f);
        noEmpty = attribute.getBoolean(R.styleable.RCDeviceWheelView_noEmpty, true);
        isEnable = attribute
                .getBoolean(R.styleable.RCDeviceWheelView_isEnable, true);
        attribute.recycle();

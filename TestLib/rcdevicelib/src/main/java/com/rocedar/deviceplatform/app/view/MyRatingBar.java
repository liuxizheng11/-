...
public class MyRatingBar  extends LinearLayout {
    ...
    public MyRatingBar(Context context, AttributeSet attrs) {
        ...
        starImageSize = mTypedArray.getDimension(R.styleable.MyRatingBar_starImageSize, 120);
        starImageWidth = mTypedArray.getDimension(R.styleable.MyRatingBar_starImageWidth, 60);
        starImageHeight = mTypedArray.getDimension(R.styleable.MyRatingBar_starImageHeight, 120);
        starImagePadding = mTypedArray.getDimension(R.styleable.MyRatingBar_starImagePadding, 15);
        starCount = mTypedArray.getInteger(R.styleable.MyRatingBar_starCount, 5);
        starNum = mTypedArray.getInteger(R.styleable.MyRatingBar_starNum, 0);
        mClickable = mTypedArray.getBoolean(R.styleable.MyRatingBar_clickable, true);
        halfstart = mTypedArray.getBoolean(R.styleable.MyRatingBar_halfstart, false);

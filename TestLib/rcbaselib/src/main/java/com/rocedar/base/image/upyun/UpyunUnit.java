...
public class UpyunUnit {
    ...
    private final static String SPACE_N3 = "cubic";

    //操作员
    private static String OPERATER_DY = "doit";
    private static String OPERATER_N3 = "cubic";
    //密码
    private static String PASSWORD_DY = "do2016it";
    private static String PASSWORD_N3 = "cubic0806";
...
//                Log.e(TAG, isSuccess + ":" + result);
        ...
        } else if (RCBaseConfig.APPTAG.equals(RCBaseConfig.APPTAG_N3)) {
            paramsMap.put(Params.BUCKET, SPACE_N3);
            UploadEngine.getInstance().formUpload(file, paramsMap,
                    OPERATER_N3, UpYunUtils.md5(PASSWORD_N3), completeListener, progressListener);
        } else {
            upYunUploadListener.upLoadError("找不到应用空间");
        }
    }

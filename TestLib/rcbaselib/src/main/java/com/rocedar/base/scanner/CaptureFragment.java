...
import com.rocedar.base.scanner.camera.CameraManager;
import com.rocedar.base.scanner.decoding.CaptureActivityHandler;
import com.rocedar.base.scanner.decoding.InactivityTimer;
        ...
        btnFlash.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    btnFlash.setBackgroundResource(R.mipmap.flash_on);
                } else {
                    CodeUtils.isLightEnable(false);
                    btnFlash.setBackgroundResource(R.mipmap.flash_off);
                }

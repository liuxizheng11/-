...
import com.rocedar.lib.sdk.scanner.decoding.CaptureActivityHandler;
import com.rocedar.lib.sdk.scanner.decoding.InactivityTimer;
...
public class CaptureFragment extends RCBaseFragment implements SurfaceHolder.Callback {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (view == null) {
            view = inflater.inflate(R.layout.rc_fragment_capture, null);
        }

        viewfinderView = (ViewfinderView) view.findViewById(R.id.viewfinder_view);
        surfaceView = (SurfaceView) view.findViewById(R.id.preview_view);
        surfaceHolder = surfaceView.getHolder();
        btnFlash = (ToggleButton) view.findViewById(R.id.btnFlash);
        //闪光灯
        btnFlash.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (isChecked) {
                    ...
                    btnFlash.setBackgroundResource(R.mipmap.rc_scan_flash_on);
                } else {
                    CodeUtils.isLightEnable(false);
                    btnFlash.setBackgroundResource(R.mipmap.rc_scan_flash_off);
                }
...
//        ((TextView) view.findViewById(R.id.rcbase_view_head_title)).setText(getString(R.string.base_scan));

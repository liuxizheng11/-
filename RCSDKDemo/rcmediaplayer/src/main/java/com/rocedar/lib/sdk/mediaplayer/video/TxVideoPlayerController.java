...
//    private TextView mShare;
    ...
    private void init() {
        LayoutInflater.from(mContext).inflate(R.layout.rc_mp_tx_video_palyer_controller, this, true);
...
//        DrawableUtil.rc_mp_seek_progress(mContext, mSeek);
...
//        mShare.setOnClickListener(this);
    ...
    private boolean isFullOnly;

    @Override
    public void setTitle(String title, boolean isFullOnly) {
        mTitle.setText(title);
        this.isFullOnly = isFullOnly;
        if (isFullOnly == true) {

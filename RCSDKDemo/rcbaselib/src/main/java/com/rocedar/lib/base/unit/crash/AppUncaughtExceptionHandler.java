...
import com.rocedar.lib.base.RCPatchDialogActivity;
...
public class AppUncaughtExceptionHandler implements UncaughtExceptionHandler {
    ...
    private boolean handlelException(Throwable ex) {
        ...
        try {
            ...
            // 提示对话框
            RCPatchDialogActivity.goActivity(applicationContext);
        } catch (Exception e) {
            return false;
        }
        return true;
    ...
    private String getCrashReport(Throwable ex) {
        ...
        PackageInfo pinfo = RCAndroid.getPackageInfo(applicationContext);
        if (pinfo != null) {
            if (ex != null) {
                //app版本信息

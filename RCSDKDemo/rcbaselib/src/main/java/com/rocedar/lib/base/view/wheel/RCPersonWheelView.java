...
public class RCPersonWheelView extends View {
     ...
     * 选中时候的字体颜色
     */
    private int selectedColor = 0xff00d755;
    /**
     * 蒙板高度
     */
    ...
    public RCPersonWheelView(Context context, AttributeSet attrs,
                             int defStyle) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray attribute = context.obtainStyledAttributes(attrs,
                R.styleable.RCPersonWheelView);
        unitHeight = (int) attribute.getDimension(
                R.styleable.RCPersonWheelView_rc_unitHight, 32);
        normalFont = attribute.getDimension(
                R.styleable.RCPersonWheelView_rc_normalTextSize, 14.0f);
        selectedFont = attribute.getDimension(
                R.styleable.RCPersonWheelView_rc_selectedTextSize, 22.0f);
        itemNumber = attribute.getInt(R.styleable.RCPersonWheelView_rc_itemNumber, 7);
        normalColor = attribute.getColor(
                R.styleable.RCPersonWheelView_rc_normalTextColor, 0xff000000);
        selectedColor = attribute.getColor(
                R.styleable.RCPersonWheelView_rc_selectedTextColor, 0xffff0000);
        lineColor = attribute.getColor(R.styleable.RCPersonWheelView_rc_lineColor,
                0xff000000);
        lineWidth = attribute.getDimension(R.styleable.RCPersonWheelView_rc_lineHeight, 2f);
        maskHight = attribute.getDimension(R.styleable.RCPersonWheelView_rc_maskHight,
                48.0f);
        noEmpty = attribute.getBoolean(R.styleable.RCPersonWheelView_rc_noEmpty, true);
        isEnable = attribute
                .getBoolean(R.styleable.RCPersonWheelView_rc_isEnable, true);
        attribute.recycle();

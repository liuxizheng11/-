...
public class RCMyRatingBar extends LinearLayout {
    ...
    public RCMyRatingBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        setOrientation(LinearLayout.HORIZONTAL);
        TypedArray mTypedArray = context.obtainStyledAttributes(attrs, R.styleable.RCMyRatingBar);

        starHalfDrawable = mTypedArray.getDrawable(R.styleable.RCMyRatingBar_rc_starHalf);
        starEmptyDrawable = mTypedArray.getDrawable(R.styleable.RCMyRatingBar_rc_starEmpty);
        starFillDrawable = mTypedArray.getDrawable(R.styleable.RCMyRatingBar_rc_starFill);
        starImageSize = mTypedArray.getDimension(R.styleable.RCMyRatingBar_rc_starImageSize, 120);
        starImageWidth = mTypedArray.getDimension(R.styleable.RCMyRatingBar_rc_starImageWidth, 60);
        starImageHeight = mTypedArray.getDimension(R.styleable.RCMyRatingBar_rc_starImageHeight, 120);
        starImagePadding = mTypedArray.getDimension(R.styleable.RCMyRatingBar_rc_starImagePadding, 15);
        starCount = mTypedArray.getInteger(R.styleable.RCMyRatingBar_rc_starCount, 5);
        starNum = mTypedArray.getInteger(R.styleable.RCMyRatingBar_rc_starNum, 0);
        mClickable = mTypedArray.getBoolean(R.styleable.RCMyRatingBar_rc_clickable, true);
        halfstart = mTypedArray.getBoolean(R.styleable.RCMyRatingBar_rc_halfstart, false);

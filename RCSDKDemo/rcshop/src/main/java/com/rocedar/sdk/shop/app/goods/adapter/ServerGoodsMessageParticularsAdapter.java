 ...
 */
public class ServerGoodsMessageParticularsAdapter extends BaseAdapter {
    private Context mContext;
    private List<RCOrderFromParticularsProgressDTO> mList = new ArrayList<>();

    public ServerGoodsMessageParticularsAdapter(Context mContext, List<RCOrderFromParticularsProgressDTO> mList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(mContext).inflate(R.layout.rc_adapter_server_goods_particulars_message, null);
            viewHolder.rc_adapter_order_particulars_topview = convertView.findViewById(R.id.rc_adapter_order_particulars_message_topview);
            viewHolder.rc_adapter_order_particulars_message_iv = convertView.findViewById(R.id.rc_adapter_server_particulars_message_iv);
            viewHolder.rc_adapter_order_particulars_message = convertView.findViewById(R.id.rc_adapter_server_particulars_message);
            viewHolder.rc_adapter_order_particulars_message_time = convertView.findViewById(R.id.rc_adapter_server_particulars_message_time);
            viewHolder.rc_adapter_order_particulars_message_gray_iv = convertView.findViewById(R.id.rc_adapter_server_particulars_message_gray_iv);

...
public interface RCIndicatorID {
    ...
    int Heart_Rate = 4013;
    //静息心率
    int Resting_Heart_Rate = 4040;
    //平均心率
    int Average_Heart_Rate = 4228;
    //心率
    int Standard_Heart_Rate = 4238;
    ...
    //4117:饮食消息,
    int DIET_MSSAGE = 4117;
    //4118 ：饮食图片,
    int DIET_IMAGE = 4118;
    //早餐时间  4056 : 20171128105832(早餐时间到秒)
    int DIET_BREAKFAST = 4056;
    //午餐 4057 : 20171128105832(午餐时间到秒)
    int DIET_LUNCH = 4057;
    //晚餐 4058 : 20171128105832(晚餐时间到秒)
    int DIET_DINNER = 4058;
    //加餐 4116 : 20171128105832(加餐时间到秒)
    int DIET_SNACKS = 4116;

    
    //  1000	早餐前
    int BEFOR_BREAKFAST = 1000;
    //  1001	早餐后
    int AFTER_BREAKFAST = 1001;
    //  1002	午餐前
    int BEFOR_LUNCH = 1002;
    //  1003	午餐后
    int AFTER_LUNCH = 1003;
    //  1004	晚餐前
    int BEFOR_DINNER = 1004;
    //  1005	晚餐后
    int AFTER_DINNER = 1005;
    //  1006	睡前
    int BEFOR_SLEEP = 1006;
    //  1007	凌晨
    int BEFOR_DAWN = 1007;
    //  1008	全选
    int SUGAR_ALL = 1008;

...
public class RequestData {
     ...
     * @param iResponseData
     */
    private static void NetWorkGetData(final Context context, final String URL,
                                       final RCBean bean, final int method,
                                       final IResponseData iResponseData) {
        //判断是否有网络
        if (NetWorkUtil.networkAvailable(context).equals("")) {
            iResponseData.getDataErrorListener("", RequestCode.STATUS_CODE_NOT_NETWORK);
            return;
        }
        String url = "";
        if (bean != null) {
            ...
            if (method == Method.Delete || method == Method.Get || method == Method.Put) {
                ...
                if (URL.equals(RCBaseManage.getInstance().url_app)) {
                    ...
                    public void onResponse(String arg0) {
                        ...
                        try {
                            ...
                            if (RequestUtil.DataProcessing(object, context) ||
                                    !URL.equals(RCBaseManage.getInstance().url_app)) {
            ...
            public Map<String, String> getHeaders() throws AuthFailureError {
                if (URL.equals(RCBaseManage.getInstance().url_app)) {
                    ...
                    return RequestUtil.headInfo(context, regix.getSignCode(bean
                            , getMethodName(method)), bean.getUserId());
                } else {
    ...
    public static void NetWorkGetData(final Context context,
        ...
        NetWorkGetData(context, RCBaseManage.getInstance().url_app, t, method, iResponseData);
    }
